makeCacheMatrix<-function(x=matrix()) {
  m<-NULL # m will be our matrix
          # It is reset to NULL every time we call makeCacheMatrix
  ...
  list(set=set,get=get,  # This is a list of the internal functions and it is accessed each time makeCacheMatrix() is called 
